...
namespace _5._1
{
    ...
    public class Order
    {
        ...
        public static Order createOrder(string tempID,string customerName,string address,string commoditName,double unitPrice,int amount)
        {
            ...
            tempOrder.TotalAmount = amount * unitPrice;
            return tempOrder;
        }
    }
    [Serializable]
    ...
    public class OrderService
    {
        ...
        public void beginService()
        {
            ...
            while (true)
            {
                Console.Write("1.添加订单 2.删除订单 3.修改订单 4.查询订单 5.输出所有订单 6.序列化订单 7.反序列化订单文件 0.退出 输入使用功能：");
                    ...
                    while (true)
                    {
                        ...
                        switch (select)
                        {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                list[index[i]].TotalAmount = double.Parse(Console.ReadLine());
                                break;
                            case 5:
        ...
        {
            if (!Directory.Exists(path)||!path.EndsWith(".xml"))
            {
